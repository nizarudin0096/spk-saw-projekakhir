    ...
    <form class="form-horizontal" action="<?php echo base_url('pengguna/tambah'); ?>" method="post">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nama_lengkap" id="nama_lengkap" class="form-control" required type="text" value="<?php echo old('nama_lengkap'); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="username" class="col-sm-2 control-label">Username</label>
                <div class="col-sm-4">
                    <input name="username" id="username" class="form-control" required type="text" value="<?php echo old('username'); ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" name="level" id="level" required>
                        ...
                        <option value="Admin" <?php echo old('level') == 'Admin' ? 'selected' : ''; ?>>Admin</option>
                        <option value="User" <?php echo old('level') == 'User' ? 'selected' : ''; ?>>User</option>
                    </select>
                </div>
            </div>
        </div>
