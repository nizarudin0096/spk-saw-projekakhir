...
<div class="box box-default">
    ...
    <form class="form-horizontal" action="<?php echo base_url('alternatif/tambah'); ?>" method="post">
        <?= csrf_field() ?>
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="kode_alternatif" id="kode_alternatif" class="form-control" required type="text" value="<?php echo old('kode_alternatif'); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="nama_alternatif" class="col-sm-2 control-label">Nama Alternatif</label>
                <div class="col-sm-4">
                    <input name="nama_alternatif" id="nama_alternatif" class="form-control" required type="text" value="<?php echo old('nama_alternatif'); ?>">
                </div>
            </div>
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="kriteria<?php echo $row['id_kriteria']; ?>" required>
                            ...
                            <?php foreach ($sub[$row['id_kriteria']] as $row_sub) : ?>
                                <option value="<?php echo $row_sub['id_subkriteria']; ?>" <?php echo old('kriteria' . $row['id_kriteria']) == $row_sub['id_subkriteria'] ? 'selected' : ''; ?>><?php echo $row_sub['nama_subkriteria']; ?></option>
                            <?php endforeach; ?>
