...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jan 2023 pada 16.44
...
(2, 'C02', 'Harga', 5, 'Cost'),
(3, 'C03', 'Kualitas', 4, 'Benefit'),
(4, 'C01', 'Pengiriman', 6, 'Cost'),
(5, 'C04', 'Tempo Pembayaran', 3, 'Benefit');
...
(1, 'Administrator', 'admin', '$2y$10$GhM5RRXSwja.Y7s2jTvgc.5arXwAG1CNSsoLVI/81uLPoefx0H3mS', 'Admin');
...
--
ALTER TABLE `alternatif`
  MODIFY `id_alternatif` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `alternatif_kriteria`
--
ALTER TABLE `alternatif_kriteria`
  MODIFY `id_alternatif_kriteria` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `subkriteria`
  MODIFY `id_subkriteria` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
